...
const OurServicesCard = ({ service }: { service: Service }) => {
  return (
    <Link
      ...
      className="group m-auto relative overflow-hidden flex flex-col justify-between gap-4 p-4 w-full max-w-[240px] h-[290px] border-2 rounded-2xl border-gn transition-transform duration-300 hover:-translate-y-1"
    >
      {/* Animated Overlay */}
