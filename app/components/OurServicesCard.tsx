...
const OurServicesCard = ({ service }: { service: Service }) => {
  return (
    ...
    >
      {/* Animated Overlay */}
      <div className="absolute inset-0 bg-emerald-600 opacity-0 group-hover:opacity-100 transition-all duration-500 origin-bottom-left scale-0 group-hover:scale-100 z-0 rounded-xl" style={{ transformOrigin: 'bottom left' }}></div>
