...
import { mainServicesPageData } from '../data/main-services'; // Correct import for mainServicesPageData

const OurServices = () => {
  const [visibleCount, setVisibleCount] = useState(3); // Default to 4 cards

  // Use mainServiceCards from mainServicesPageData
  ...
  useEffect(() => {
    const updateVisibleCount = () => {
      ...
      else setVisibleCount(3);                      // default (sm, md)
    };
  ...
  return (
    <section className='w-full bg-white py-16 px-4'>
      <div className='max-w-6xl mx-auto flex flex-col gap-10'>
        ...
        {/* Cards Grid */}
        <div className='grid grid-cols-1 sm:grid-cols-3 md:grid-cols-3 lg:grid-cols-5 gap-6 justify-items-center'>
