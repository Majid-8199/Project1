    ...
    <div className='flex flex-col lg:flex-row items-center justify-center min-h-[100vh] gap-10 px-4 overflow-x-hidden'>
      ...
      >
        <div className='flex flex-col gap-2 justify-center'>
          <WhyUsCard feature={selectedFeatures[0]} data-aos="zoom-in" data-aos-delay="100" />
          <div className='h-1 w-[95%] bg-rd items-center hidden sm:block'></div>
          <WhyUsCard feature={selectedFeatures[1]} data-aos="zoom-in" data-aos-delay="200" />
        </div>
        <div className='w-3 bg-gn'></div>
        <div className='flex flex-col items-center gap-2 justify-center'>
          <WhyUsCard feature={selectedFeatures[2]} data-aos="zoom-in" data-aos-delay="300" />
          <div className='h-1 w-[95%] bg-rd hidden sm:block'></div>
          <WhyUsCard feature={selectedFeatures[3]} data-aos="zoom-in" data-aos-delay="400" />
        </div>
      </div>
    </div>
  );
